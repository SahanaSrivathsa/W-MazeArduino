    ...
    //Solenoid
    const int solDur1 = 200; //duration solenoid is open on reward for solenoid 1
    const int solDur2 = 200; //duration solenoid is open on reward for solenoid 2
    const int solDur3 = 200; //duration solenoid is open on reward for solenoid 3
    ...
    const char testMessage = 'T';
    const char trainMessage = 'R';
